...
{
    public sealed class CanteenCheckerVoiceCommandService : IBackgroundTask
    {
        /// <summary>
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            if (triggerDetails != null && triggerDetails.Name == nameof(CanteenCheckerVoiceCommandService))
            {
                try
                {
                    ...
                    // TODO: Get voice command

                    // TODO: Depending on the operation perform the appropriate command.
                }
                catch (Exception ex)
                {
        ...
        private async Task HandleSearch(string canteen, string meal)
        {
            // TODO: handle search and interact with user
        }
        ...
        private async void LaunchAppInForeground()
        {
            ...
            userMessage.SpokenMessage = "Starte Canteen Checker";
