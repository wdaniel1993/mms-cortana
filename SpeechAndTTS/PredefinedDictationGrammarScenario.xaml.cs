...
namespace SpeechAndTTS
{
    public sealed partial class PredefinedDictationGrammarScenario : Page
    {
        ...
        private async Task InitializeRecognizer(Language recognizerLanguage)
        {
            ...
            // The second parameter "dictation" is a topic hint to optimize recognition: valid values are: 
            //     "Natural Language", "WebSearch", "Short Message", "Dictation", "Command", or "Form Filling"
