    ...
    public sealed partial class ListConstraintScenario : Page
    {
        ...
        private async Task InitializeRecognizer(Language recognizerLanguage)
        {
            ...
            try
            {
                ...
                // The SpeechRecognitionScenario offers three predefined scenarios:
                //  a) dictation, b) form filling input, c) a web search scenario.

                // dictation : The default free-text dictation grammar can recognize most words and phrases that a user can say 
                //             in a particular language, and is optimized to recognize short phrases
                // web search: contains a large number of words and phrases that a user might say. However, it is optimized 
                ...
                // SpeechRecognitionTopicConstraint class: A pre-defined grammar constraint provided through a web service.
                //                                         You can specify one of the pre-defined, web-service grammars or 
                //                                         you can create your own custom grammar that is installed with your app.
                // 
                // 1. Predefined grammars: speech recognition for your app without requiring you to author a grammar. 
                //                      When using these grammars, speech recognition is performed by a remote web service 
                //                      and the results are returned to the device. --> internet connection required
                // 2. Programmatic list constraints: Provides a lightweight approach for creating simple grammars using 
                //                      a list of words or phrases. --> array of strings that represents speech input 
                // 3. SRGS grammars :   A static document which provides the greatest control over the speech recognition 
                //                      experience by letting you capture multiple semantic meanings in a single recognition.
                // 4. Voice command constraints: Use a Voice Command Definition (VCD) XML file to define the commands that the user
                //                      can say to initiate actions when activating your app. --> this will be shown in the
                //                      second part of the lab session in MMS2/MUS2.

                // Add a list constraint to the recognizer.
                //
                // The resource file LocalizationSpeechResources.resw is in the Strings folder and
                // contains the localized text constraints (e.g. phrases) for a given key.
                // A list constraint works well for recognizing short, distinct phrases. 
                //
                // Explicitly specifying all words in a grammar also improves recognition 
                // accuracy, as the speech recognition engine must only process speech to 
                // confirm a match. The list can also be programmatically updated.
                //
