...
namespace SpeechAndTTS
{
    public sealed partial class SynthesizeSSMLScenario : Page
    {
        ...
        public SynthesizeSSMLScenario()
        {
            ...
            // EXPLAIN_START
            // Resources File (.rejson) for a JavaScript project and 
            // Resources File (.resw) for a C# project.
            // The file is located in SpeechRecognitionAndSynthesis\shared\Strings\de-DE
        ...
        private void ListboxVoiceChooser_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            // EXPLAIN_START
            // we load a SSML (= XML) text into the text field
        ...
        private void UpdateSSMLText()
        {
            try
            {
                ...
                doc.LoadXml(text);
                // EXPLAIN_START
                // the XML attribut xml:lang="de-DE" defines the language being used
                // e.g. <speak version="1.0" ... xml:lang="de-DE">
                // The language should be in line with the chosen voice (DE, US, etc.)
                // otherwise do we get a mix of e.g. enlish voice with a english pronounciation 
                // speaking german text.
